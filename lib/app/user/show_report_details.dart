...
class ShowReportDetails extends StatefulWidget {
  ...
  const ShowReportDetails({Key key, @required this.database, this.report}) : super(key: key);
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              child: Center(
                child: Text('Severity : ${widget.report.severity}',
                style: TextStyle(
                  fontSize: 15.0,
                  color: Colors.black,
                )
            ...
            Container(
              child: Center(
                child: Text('Location : ${widget.report.location['address']}',
                  style: TextStyle(
                    fontSize: 15.0,
                    color: Colors.black,
                  )
            ...
            Container(
              child: Center(
                child: Text('Latitude : ${widget.report.location['latitude']}',
                  style: TextStyle(
                    fontSize: 15.0,
                    color: Colors.black,
                  )
            ...
            Container(
              child: Center(
                child: Text('Longitude : ${widget.report.location['longitude']}',
                  style: TextStyle(
                    fontSize: 15.0,
                    color: Colors.black,
                  )
